...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <!-- <img src="images/icon/cps1.png" alt="Mess Management System" /> -->
                    <?php echo '<img src="images/icon/cps1.png"/>'; ?>
                </a>
            </div>
...
$Total_User=0;
        ...
        $res1= mysqli_query($con,"select * from Transaction");
        $Total_Book=mysqli_num_rows($res1);
        $res3= mysqli_query($con,"select * from menu");
        $Total_Menu=mysqli_num_rows($res3);
        $res4= mysqli_query($con,"select * from users");
        $Total_User=mysqli_num_rows($res4);
        
        $res2= mysqli_query($con,"select SUM(Amount) from Transaction");
        
        $row = mysqli_fetch_array($res2);
        $Total_Earn=$row['SUM(Amount)'];
